...
const TabataIcon = () => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 60.58 60.58">
            <title>Tabata</title>
            <g>
                <rect className={`${commonIconStyles.filledHighlight} ${commonIconStyles.dark}`} x="3.92" y="12.87" width="43.8" height="43.8"
                      rx="5.73" ry="5.73"/>
                <g className={commonIconStyles.filledDark}>
                    <line x1="4.34" y1="22.91" x2="47.72" y2="22.91"/>
                    <line x1="4.34" y1="45.1" x2="47.72" y2="45.1"/>
                    <line x1="4.34" y1="34.01" x2="47.72" y2="34.01"/>
                </g>
                <path className={commonIconStyles.filledDark}
                      d="M33.14,15.1H9.44c-1.87,0-3.39,1.52-3.39,3.39v3.97h27.1v-7.36Z"/>
                <rect className={commonIconStyles.filledDark} x="6.04" y="36.15" width="39.25" height="8.95"/>
                <circle
                    className={`${commonIconStyles.filledHighlight} ${commonIconStyles.stroked} ${commonIconStyles.dark}`}
                    cx="43.84" cy="17.86" r="12.12"/>
                <path className={`${commonIconStyles.stroked} ${commonIconStyles.dark}`}
